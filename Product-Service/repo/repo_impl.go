...
func (r *Repo) GetProductByID(ctx context.Context, prodID string, span opentracing.Span) (db.Product, error) {
...
func (r *Repo) GetAllProducts(ctx context.Context, span opentracing.Span) ([]db.Product, error) {
