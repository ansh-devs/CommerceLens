...
func registerService() {
	...
	instance := eureka.NewInstanceInfo("192.168.1.5", "Login-Service", "192.168.1.5", 50003, 5, false) //Create a new instance to register
	instance.Metadata = &eureka.MetaData{
		Map: make(map[string]string),
	}
	instance.Metadata.Map["grpcuri"] = "192.168.1.5:50002" //add metadata for example
	err := client.RegisterInstance("login-service", instance)
	if err != nil {
		return
